...
import 'package:travel_app/modules/categories.dart';
import 'package:travel_app/modules/favourite.dart';

import '../../models/category_model.dart';

class TravelCubit extends Cubit<TravelStates>{
  TravelCubit() : super(TravelInit());
  ...
  void changeSwitchValue2(value){
    switchValue2 = value;
    emit(ChangeSwitchValue());
  }
  bool switchValue3 =false;
  void changeSwitchValue3(value){
    switchValue3 = value;
    emit(ChangeSwitchValue());
  }
  String? removeItem;
